...
ALTER TABLE [militaries] ADD FOREIGN KEY ([nation_id]) REFERENCES [nations] ([nation_id])
GO

ALTER TABLE [militaries] ADD FOREIGN KEY ([alliance_id]) REFERENCES [alliances] ([alliance_id])
GO
